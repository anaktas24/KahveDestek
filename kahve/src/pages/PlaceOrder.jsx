...
const PlaceOrder = () => {
  ...
  const [method,setMethod] = useState('cod') //cash on delivery if needed.
    ...
    <div className='flex flex-col sm:flex-row justify-between gap-4 pt-5 sm:pt-14 min-h-[80vh] border-t'>
      ...
      <div className="flex flex-col gap-4 w-full sm:w-[480px]">
        ...
        <div className="flex gap-3">
          ...
          <input type='text' placeholder='Street adress' className='border border-gray-300 rounded py-1.5 px-3.5 w-full'/>
        <div className="flex gap-3">
        ...
        <div className="flex gap-3">
          <input type='number' placeholder='PLZ' className='border border-gray-300 rounded py-1.5 px-3.5 w-full'/>
